...
def augment_sample(audio_sample_path, target_seconds=3, stretch_low=1.1, stretch_high=1.5, pitch_low=1.5, pitch_high=4,
                   noise_low=0.001, noise_high=0.01):
    ...
    audio_regions_arrays, audio_regions_info = merge_regions(audio_regions_arrays, audio_regions_info)
    ...
    audio_regions_arrays = [time_stretch(ar, stretch_low, stretch_high) for ar in audio_regions_arrays]
    audio_regions_arrays = [change_pitch(ar, pitch_low, pitch_high) for ar in audio_regions_arrays]
    ...
    final_ar = noise_injection(final_ar, noise_low, noise_high)
